...
The current strict graph records the exact Z carrier/iinite-observation split, the i4 optimizer stability consumer, and leit-inverse injectivity promotion. The promoted Hodge-Maxwell/Tsallis/Walrasian theorem remains conditional on its explicit premises; it is not a claim that HardSign is convex or diiierentiable.
