...
-- v150: LayerNorm-free Efficient-CHAD, CReLU representation, finite-window
-- Tsallis-2 sparse routing, magnitude-aware q-IDBD, dyadic coupled L2,
-- representation L1 weight norm, one-path norm, finite ordered certificates.
