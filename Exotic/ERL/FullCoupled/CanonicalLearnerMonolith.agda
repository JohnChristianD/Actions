...
------------------------------------------------------------------------
-- Self-contained finite learner carrier.
-- No environment, statistical process, probability law, replay store,
-- posterior sampler, or project-local Agda import occurs here.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Small endogenous deduction kernel.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Exact finite signed carrier and Mobius x/(1-x) boundary.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Watkins critic, deterministic LCB memory, fixed-temperature sparsemax.
------------------------------------------------------------------------
...
... | finiteRational s n d = finiteRational (suc 0) n d
...
------------------------------------------------------------------------
-- Learned sparsemax attention is representation state, not actor state.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Exact Walsh-Hadamard H4 algebraic boundary.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Hard-sign-derived, input-driven recurrent carrier.
------------------------------------------------------------------------
...
mix8 g old new = int8Add (int8Mul (q7Complement128 (toℕ (code g))) old) (int8Mul g new)
...
------------------------------------------------------------------------
-- Global F4-Int-U(p)-style optimizer and NormPair.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Whole endogenous learner state and one-step transition.
------------------------------------------------------------------------
...
canonicalFullStep-clock : ∀ K s →
  clock (canonicalFullStep K s) ≡ suc (clock s)
canonicalFullStep-clock K s = refl

canonicalFullStep-watkins : ∀ K s →
  watkins (canonicalFullStep K s) ≡ canonicalWatkinsStep K s
canonicalFullStep-watkins K s = refl

canonicalFullStep-attention : ∀ K s →
  attention (canonicalFullStep K s) ≡ canonicalAttentionStep K s
canonicalFullStep-attention K s = refl

canonicalFullStep-gru : ∀ K s →
  gru (canonicalFullStep K s) ≡ canonicalGRUStep K s
canonicalFullStep-gru K s = refl

canonicalFullStep-optimizer : ∀ K s →
  optimizer (canonicalFullStep K s) ≡ canonicalOptimizerStep K s
canonicalFullStep-optimizer K s = refl

canonicalFullStep-counts : ∀ K s →
  lcbCounts (canonicalFullStep K s) ≡ canonicalCountStep K s
canonicalFullStep-counts K s = refl

canonicalFullStep-qLog : ∀ K s →
  qLogValue (canonicalFullStep K s) ≡ canonicalQLogStep K s
canonicalFullStep-qLog K s = refl

canonicalFullStep-qLogControl : ∀ K s →
  qLogControl (canonicalFullStep K s) ≡ canonicalQLogControlStep K s
...
canonicalOrbitNonFixed : ∀ K s n →
  iterateCanonical K n s ≢ canonicalFullStep K (iterateCanonical K n s)
...
canonicalTotalCountIterate2 : ∀ K s →
  totalCount (iterateCanonical K 2 s) ≡ suc (suc (totalCount s))
...
canonicalNoCountedTwoCycle K s cyc =
  suc-suc-not-self (totalCount s)
  (trans (sym (canonicalTotalCountIterate2 K s)) (cong totalCount cyc))

------------------------------------------------------------------------
-- Regression-level closed terms.
------------------------------------------------------------------------

temperatureCodeLaw : sparsemaxTemperature ≡ int8OfNat 16
temperatureCodeLaw = refl

temperatureTieLaw : fixedTemperatureSparsemax
  (actionScore (int8OfNat 0) (int8OfNat 0)) ≡ int8OfNat 64 , int8OfNat 64
temperatureTieLaw = refl

temperaturePositiveUnitLaw : fixedTemperatureSparsemax
  (actionScore (int8OfNat 1) (int8OfNat 0)) ≡ int8OfNat 68 , int8OfNat 60
temperaturePositiveUnitLaw = refl

temperatureNegativeUnitLaw : fixedTemperatureSparsemax
  (actionScore (int8OfNat 0) (int8OfNat 1)) ≡ int8OfNat 60 , int8OfNat 68
