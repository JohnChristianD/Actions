...
------------------------------------------------------------------------
-- Finite folds and the canonical algebraic scalar layer
------------------------------------------------------------------------
...
module EfficientCHADRing (Rg : Ring) where
  open Ring Rg
  R : Set
  R = Ring.R Rg
...
------------------------------------------------------------------------
-- Parser-safe monolithic reverse-state accumulator
------------------------------------------------------------------------
