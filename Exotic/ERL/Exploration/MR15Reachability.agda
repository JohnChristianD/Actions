...
reachable-uniform (there step rest) =
  reachable-uniform-from-step step (reachable-uniform-from-step rest)
  where
  reachable-uniform-from-step : ∀ {x y : Population} →
    Reach mr15Step x y → Uniform x → Uniform y
  reachable-uniform-from-step here u = u
  reachable-uniform-from-step (there step' rest') u =
    reachable-uniform-from-step rest' (step-preserves-uniform step' u)
